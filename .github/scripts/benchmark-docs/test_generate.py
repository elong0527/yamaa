...
class DashboardTests(unittest.TestCase):
    ...
    def test_negative_failure_has_banner_and_own_section(self):
        ...
        base = "https://github.com/elong0527/yamaa/edit/main/benchmarks/negative-output-duplicate-subject"
        self.assertIn(
    ...
    def test_multi_level_spec_renders_panes_with_resolved_default(self):
        ...
        base = "https://github.com/elong0527/yamaa/edit/main/benchmarks/spec-inheritance"
        for path in [
            "spec_organization.yaml",
            "spec_compound.yaml",
            "spec_study.yaml",
