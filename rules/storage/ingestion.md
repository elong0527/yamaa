...
| Field | Meaning |
| --- | --- |
| `dataset_class.path` | Source data path, relative to the specification that writes it (or to the entry file under [REQ-1246](../specification/composition.md#req-1246)) or rooted at an approved data root and confined by [Resource resolution](resources.md); [CSV profile](csv.md) selects the source profile from its extension. |
