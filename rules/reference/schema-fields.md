...
| `row_class.catalog` | `"row_catalog_class"` | `false` | Absent | -- | [REQ-1248](../execution/rows.md#req-1248) |
| `row_class.submission` | `"dict[identifier, submission_column_class]"` | `false` | Absent | -- | [REQ-1056](../execution/rows.md#req-1056) |
| `row_catalog_class.path` | `"project_path"` | `true` | Absent | -- | [REQ-1248](../execution/rows.md#req-1248) |
| `row_catalog_class.id_column` | `"identifier"` | `true` | Absent | -- | [REQ-1248](../execution/rows.md#req-1248) |
| `row_catalog_class.types` | `"dict[identifier, row_catalog_type]"` | `false` | Absent | -- | [REQ-1248](../execution/rows.md#req-1248) |
| `row_catalog_class.unique_columns` | `"list[identifier]"` | `false` | Absent | -- | [REQ-1248](../execution/rows.md#req-1248) |
| `row_catalog_type` | `"str"` | `false` | Absent | `{"values": ["str", "int", "float"]}` | [REQ-1248](../execution/rows.md#req-1248) |
