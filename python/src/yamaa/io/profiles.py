...
# an artifact can be consumed under the profile that produced it. REQ-1182
# admits a container here only when it carries every value the language does,
# and REQ-1183 keeps SAS Transport out on that ground; an extension this table
# omits is refused under REQ-0760 rather than named as a declined container.
