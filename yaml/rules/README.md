...
| R004 | [Predicate language](R004-expression-language.md) | draft | The Boolean `sql` primitive | R002, R006 |
| R005 | [Output contract](R005-output-contract.md) | normative | Column coverage, output membership, the value lifecycle, output identity | R001, R003, R008, R009, R011 |
| R006 | [Compact schema language](R006-schema-language.md) | normative | Schema notation and structural validation | — |
| R007 | [Expression registry](R007-expression-registry.md) | normative | Registration, nesting, evaluation kinds, ordering, input types | R003, R004, R005, R006, R008, R010, R011 |
| R008 | [Local error handlers](R008-local-handlers.md) | normative | The handler lifecycle | R002, R003, R005, R006, R007 |
...
| R011 | [Column types](R011-column-types.md) | normative | The `column_type` vocabulary and conversion | R005, R006, R007, R010 |
...
declared in `depends_on` and must be complete, including the ones a rule
reaches only through a cross-reference in its body.
