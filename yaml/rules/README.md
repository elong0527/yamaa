...
Closed syntax remains defined in [grammar/](../grammar/README.md), with
...
evidence. The [cutover record](../rule-migration.md) explains the migration
and its deliberately retained implementation limits.
