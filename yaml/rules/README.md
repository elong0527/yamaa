...
| R011 | [Column types](R011-column-types.md) | normative | The `column_type` vocabulary and conversion | R005, R006, R007, R008, R010, R014 |
...
| R014 | [Datetime values](R014-datetime-values.md) | normative | The `datetime` value: lexical form, zone and precision model, comparison, canonical text | R006, R007, R011 |
