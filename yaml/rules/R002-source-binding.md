...
depends_on: [R003, R006, R008, R014, R015, R019, R020]
---
...
files a declared path may reach, and the bytes a run reads from one, is R020.
...
and confined by R020. R017 preserves that origin when a declaration is
...
- A source path that R020 does not accept: fail, under R020's condition.
