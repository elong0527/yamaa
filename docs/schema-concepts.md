...
| `source_binding_class` | a `source:` that needs a handler | [`sdtm-dm-basic/spec.yaml:62`](https://github.com/elong0527/yamaa/blob/main/yaml/examples/sdtm-dm-basic/spec.yaml#L62) |
