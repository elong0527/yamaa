...
subtitle: "from ODM to SDTM / ADaM and define.xml<br>NJSUG & PhilaSUG Joint In-Person Meeting 2026"
author: "Yilong Zhang"
date: "2026-10-09"
...
* A reviewer must resolve the difference before signing off.

In a drug-manufacturing [warning letter](https://www.fda.gov/inspections-compliance-enforcement-and-criminal-investigations/warning-letters/purolea-cosmetics-lab-722591-04022026), the FDA wrote:

> "you must review the AI generated documents to ensure they were accurate and actually compliant with CGMP."

## Root cause

The specification leaves business rules implicit, so agents must infer them.

Business rules can differ from language defaults:

- [R](https://stat.ethz.ch/R-manual/R-devel/library/base/html/Round.html) and [Python](https://docs.python.org/3/library/functions.html#round) round exact ties to even.
- [SAS](https://documentation.sas.com/api/docsets/lrcon/9.4/content/lrcon.pdf) compares missing numeric values as lower than nonmissing values.

## Goal

- Reduce human review work
- Leverage organization templates
- Capture domain knowledge that agents can apply

## yamaa: YAML specification
...
- Annotated CRF is not an input but output.
- Excel specification is not an input but output.
